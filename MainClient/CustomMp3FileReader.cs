...
namespace NAudio.Wave
{
    ...
    public class CustomMp3FileReader : WaveStream
    {
        ...
        public CustomMp3FileReader(string mp3FileName)
        ...
        public CustomMp3FileReader(Stream inputStream)
        {
            int sampleRate;
            int bitRate;
            ...
            watch.Start();
            Console.WriteLine("TEST1: " + watch.ElapsedTicks);

            mp3Stream = inputStream;
            id3v2Tag = Id3v2Tag.ReadTag(mp3Stream);

            Console.WriteLine("TEST2: " + watch.ElapsedTicks);

            dataStartPosition = mp3Stream.Position;
            var mp3Frame = new CustomMp3Frame(mp3Stream);
            Console.WriteLine("TEST3: " + watch.ElapsedTicks);
            ...
            Console.WriteLine("TEST4: " + watch.ElapsedTicks);
        ...
        public CustomMp3Frame ReadNextFrame()
        {
            if (Position < Length)
            {
                return new CustomMp3Frame(mp3Stream);
            }
            return null;
        }
        ...
        /// </summary>
        public int GetReadSize(int milliseconds)
        {
